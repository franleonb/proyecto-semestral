...
Esto ayuda a comprender de mejor manera cómo cambia realmente y en la práctica la alimentación al adoptar una dieta vegana.
...
## Comparación de disponibilidad entre supermercados
Para esta visualización, utilizamos los datos que recogimos al inicio del semestre para comparar la disponibilidad de productos veganos en tres supermercados chilenos (Jumbo, Líder y Tottus). Nos dimos cuenta que cada supermercado tiene una oferta diferente, siendo la de Jumbo la más completa y la de Tottus la más incompleta. Nos pareció importante de añadir al reportaje ya que, además de abordar la arista de la disponibilidad y accesibilidad de productos veganos, también coincide con el [Ranking Vegano de Supermercados](https://www.rankingsupermercados.com/), el cual posiciona a Jumbo con el supermercado con mayor oferta vegana y a Tottus con menor disponibilidad de los tres.
...
## Ficha Técnica Gráfico 4
Este gráfico se basó en los datos recogidos en la entrega 2 por cada integrante. Se agregó la categoría **"Disponibilidad"** para ordenar los productos que se encontraban de los que no. Se utilizó el critero de que cada producto fuera efectivamente vegano y reemplazara de manera correcta a su versión tradicional.
